...
public class Land {
    ...
    private Texture land1;
    private Texture land2;
    private Texture land3;
	
	private MainCharacter mainCharacter;
	
	public Land(int width, MainCharacter mainCharacter) {
		this.mainCharacter = mainCharacter;
        land1 = new Texture("data/land1.png");
        land2 = new Texture("data/land2.png");
        land3 = new Texture("data/land3.png");
	...
	public void draw(SpriteBatch batch) {
	    for(ImageLand imgLand : listLand) {
	        batch.draw(imgLand.texture, imgLand.posX, LAND_POSY);
	    }
	}
